# Modelos de E-mail de Encaminhamento

Modelos prontos para uso no fluxo de handoff do SILIC 2.0.
...
- Documento de requisitos final: [anexo/link]
- Link Figma final aprovado: [inserir link]
